...
const Contact = () => {
  ...
  // https://i.pinimg.com/1200x/73/75/0c/73750cdb03d2c9c435db2672476e4165.jpg

  return (
    <div>
      
      <div className="container mx-auto lg:flex justify-center lg:pt-[100px] pt-[80px] mb-5 ">
          
          <div className= {`${isSubmit? "w-full" : "auto"} sm:block hidden`}>
            {
              isSubmit? 
              <img src="https://i.pinimg.com/1200x/19/41/3b/19413b1439415587fac23eeeb4dbc372.jpg" alt="Contact Image" className=
              {`${isSubmit? "object-cover lg:h-[500px] lg:w-[100%] relative" : "object-cover  rounded-2xl lg:block "}`} />
              : <img src="https://i.pinimg.com/736x/ac/a6/9e/aca69ea8940387034de7e3f8dcfc5835.jpg" alt="Contact Image" className="object-cover rounded-2xl lg:block sm:hidden" />
            }

            {isSubmit && <button className="absolute right-12 top-35 text-lg font-bold bg-red-300 lg:w-7 lg:rounded-2xl hover:bg-red-700 hover:scale-125" onClick={()=>setIsSubmit(false)}>X</button>}
          </div>

          <form onSubmit={handleSubmit} className={`lg:w-[50%] lg:mx-10 sm:mx-auto p-10 bg-red-50 rounded-3xl shadow-lg sm:w-[90%] ${isSubmit? "hidden" : "block"}`} >
